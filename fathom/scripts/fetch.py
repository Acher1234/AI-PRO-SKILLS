...
# Skill location (where this skill is registered / its shared library), resolved
# via common/skill_home.py; falls back to the folder containing scripts/.
try:
    from _skill_home import get_skill_home
    SKILL_DIR = Path(get_skill_home())
except Exception:
    SKILL_DIR = Path(__file__).resolve().parent.parent

# Default output directory: a "meetings" folder inside the skill location
